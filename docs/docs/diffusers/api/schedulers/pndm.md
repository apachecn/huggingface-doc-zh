...
[<
 ...
 >](https://github.com/huggingface/diffusers/blob/v0.23.0/src/diffusers/schedulers/scheduling_pndm.py#L72)
...
[<
 ...
 >](https://github.com/huggingface/diffusers/blob/v0.23.0/src/diffusers/schedulers/scheduling_pndm.py#L394)
...
[<
 ...
 >](https://github.com/huggingface/diffusers/blob/v0.23.0/src/diffusers/schedulers/scheduling_pndm.py#L170)
...
[<
 ...
 >](https://github.com/huggingface/diffusers/blob/v0.23.0/src/diffusers/schedulers/scheduling_pndm.py#L230)
...
process from the learned model outputs (most often the predicted noise), and calls
 [step\_prk()](/docs/diffusers/v0.23.0/en/api/schedulers/pndm#diffusers.PNDMScheduler.step_prk) 
 or
 [step\_plms()](/docs/diffusers/v0.23.0/en/api/schedulers/pndm#diffusers.PNDMScheduler.step_plms) 
 depending on the internal variable
 `counter` 
.
...
[<
 ...
 >](https://github.com/huggingface/diffusers/blob/v0.23.0/src/diffusers/schedulers/scheduling_pndm.py#L323)
...
[<
 ...
 >](https://github.com/huggingface/diffusers/blob/v0.23.0/src/diffusers/schedulers/scheduling_pndm.py#L263)
